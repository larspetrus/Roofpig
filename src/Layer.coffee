...
class Layer
  ...
  @U: new Layer('U', v3( 0, 0, 1), ['UBR','UBL','UFL','UFR'],['UR','UB','UL','UF'], ['U'], F:'L', L:'B', B:'R', R:'F', U:'U', D:'D')
  @D: new Layer('D', v3( 0, 0,-1), ['DFR','DFL','DBL','DBR'],['DF','DL','DB','DR'], ['D'], F:'R', R:'B', B:'L', L:'F', U:'U', D:'D')
